...
from excel_data_config import ExceDataConfig
...
class GetData(object):
    ...
    def get_json_data(self,row):
        ...
        :return:
        '''
        json_data = self.oper_json.get_json_value(self.get_request_data())
        return json_data
    ...
    def get_expect_data(self,row):
        ...
        if 'Mysql::' in expect_data:
            expect_data = self.oper_sql.deal_string(expect_data)
            return expect_data
        if expect_data:
            return expect_data
        else:
